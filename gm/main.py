...
def main():
    ...
    eval_it_pool = np.arange(0, args.Iteration+1, 50).tolist() if args.eval_mode == 'S' else [args.Iteration] # The list of iterations when we evaluate models and record results.
