...
def parse_args():
    ...
    parser.add_argument('--cifar', action='store_true', help='use cifar data')
...
if __name__ == '__main__':
    ...
    if args.cifar:
        dataset = Datasets.cifar10_dataset(train=False)
        test_loader = DataLoader(dataset, batch_size=512, pin_memory=True, num_workers=8)
    else:
