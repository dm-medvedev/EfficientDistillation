...
if __name__ == "__main__":
    ...
    usual_args = {'hpo_lr':1e-3, 'trunc':10, 'bsz':100, 'epochs':1_000, 'mx':10}
    iargs = [] # [('bsz', el, ep) for el, ep in zip([500, 300, 100], [280, 360, 1080])]
    margs = [] # [('mx', el, ep) for el, ep in zip([1, 50],  [1440, 500])]
    targs = [('trunc', el, ep) for el, ep in zip([5, 30], [1440, 500])]
