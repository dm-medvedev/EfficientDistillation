...
def set_config(bsz:int, ic:int, epochs:int, teacher_k:int):
    learner_c = LearnerConfig(arch="ConvNet",
                              ...
                              optim_kwgs={"lr": 2e-2, 
                                          "momentum": 0.5})
    data_c = RealDataConfig(channel=3,
                            im_size=(32, 32),
                            num_classes=10,)
    ...
    teacher_c = MNISTTeacherConfig(input_size=64,
                                   ...
                                   conv2_filters=loop_c.data_c.channel,
...
def get_loader():
    dataset = Datasets.cifar10_dataset(train=True)
...
if __name__ == "__main__":
    ...
    arg = {'bsz':500, 'ous':10, 'ls':10, 'ic':1, 'teacher_k':128,
